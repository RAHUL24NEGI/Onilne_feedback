...
$sql=mysqli_query($conn,"select * from faculty where fac_id='$user' ");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=view_feedbackfac"><span class="glyphicon glyphicon-user"></span> View Feedback</a></li>
      ...
      else if($page=="view_feedbackfac")
			{
				include('view_feedbackfac.php');

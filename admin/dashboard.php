            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Subject info.<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                            <li>
                                    <a href="dashboard.php?info=add_subinfo"><i class="fa fa-plus fa-fw"></i> Add Subject</a>
                                </li>
                                <li>
                                    <a href="dashboard.php?info=display_subinfo"><i class="fa fa-eye"></i> Manage Subject</a>
                                </li> 
							</ul>
                        </li>
                        ...
                        <li>
                            <a href="dashboard.php?info=upload_feedback"><i class="fa fa-user fa-fw"></i>Feedback</a> 
                        </li>
                	...
                	<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="display_student")
                                        ...
                                        else if($info=="add_subinfo")
										{
										include('add_subinfo.php');
										}

                                        else if($info=="display_subinfo")
										{
										include('display_subinfo.php');
										}
                                        else if($info=="updatestupass")
										{
										include('updatestupass.php');
										}
                                        else if($info=="updatefacpass")
										{
										include('updatefacpass.php');
										}
                                        else if($info=="confirmation")
										{
										include('confirmation.php');
										}
                                        else if($info=="upload_feedback")
										{
										include('upload_feedback.php');
										}

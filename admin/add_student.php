...
$r=mysqli_num_rows($sql);
	...
	else
	{
		...
		$query="insert into user values('$id','$n','$p','$year','$sem')";
		if($sem==2*$year || $sem==2*$year-1)
		{
			...
			$err="<font color='blue'><h3 align='center'>Registration successfull !!<h3></font>";
 			...
 			$err="<font color='red'><h3 align='center'>Fill Year/Semester Correctly</h3>";
		}
	}
}
...
<h4> Upload excel in this format(Default password will be Student ID)</h4>
    <img src="../images/ex2.png" alt="#" width="500" height="600">
